...
do
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local DropdownArrow = Library:Create('ImageLabel', {
            ...
            Image = 'http://www.roblox.com/asset/?id=16131678880';
            ZIndex = 7;
            Parent = DropdownInner;
        });
...
ImageButton.Image = "http://www.roblox.com/asset/?id=16131678880"
...
local B = Main:AddTab('Cuttay Account Farm')
